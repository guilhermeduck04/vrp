...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	["Juiz"] = { _config = { title = "Juiz", gtype = "job", salario = 15000, org = "Juiz" }, "juiz.permissao", "polpar.permissao" },
	["Advogado"] = { _config = { title = "Advogado", gtype = "job", salario = 12000, org = "Advogado" }, "advogado.permissao", "polpar.permissao" },
