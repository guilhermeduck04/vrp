...
cfg.deathNUItimer = 1 -- Tempo de morte que o jogador vai conseguir utilizar o botao de desistir imediatamente
cfg.deathtimer = 400 -- Tempo in coma
cfg.minHealth = 101 -- o Minimo de vida do seu servidor
cfg.maxHealth = 400 -- o Minimo de vida do seu servidor
cfg.cooldown = 15 -- Delay por pessoa, para evitar FLOODS de Logs no DISCORD [ OBS: Deixar sempre maior que 10 ]
cfg.respawn = vec3(0,0,0) -- Localização quando o jogador respawnar
